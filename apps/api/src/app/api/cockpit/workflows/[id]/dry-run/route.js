...
import { dryRunWorkflowStudio } from '@/lib/domain/workflow-v2/workflow-studio-bridge.js';
...
export async function POST(request, { params }) {
  ...
  try {
    ...
    const result = await dryRunWorkflowStudio(await workflowIdFromParams(params), payload);

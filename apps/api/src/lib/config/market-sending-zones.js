...
/** Every US state + DC maps to an approved regional sender cluster. */
const STATE_CLUSTER_MAP = Object.freeze({
  ...
  LA: "atlanta_cluster",
  MS: "atlanta_cluster",
  SC: "charlotte_cluster",
  NC: "charlotte_cluster",
  VA: "charlotte_cluster",
  WV: "charlotte_cluster",
  DC: "charlotte_cluster",
  DE: "charlotte_cluster",
  NY: "charlotte_cluster",
  NJ: "charlotte_cluster",
  CT: "charlotte_cluster",
  MA: "charlotte_cluster",
  RI: "charlotte_cluster",
  VT: "charlotte_cluster",
  NH: "charlotte_cluster",
  ME: "charlotte_cluster",
  TX: "dallas_houston_cluster",
  OK: "dallas_houston_cluster",
  AR: "dallas_houston_cluster",
  ...
  OR: "los_angeles_cluster",
  MT: "los_angeles_cluster",
  WY: "los_angeles_cluster",
  AK: "los_angeles_cluster",
  HI: "los_angeles_cluster",
  ...
  ND: "minneapolis_cluster",
  SD: "minneapolis_cluster",
});

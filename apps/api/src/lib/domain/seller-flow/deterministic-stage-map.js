...
const EXPLICIT_INTENT_RULES = Object.freeze({
  ...
  non_owner_referral: Object.freeze({
    next_stage: "referral_review",
    template_use_case: null,
    safety_tier: SELLER_FLOW_SAFETY_TIERS.REVIEW,
    auto_send_eligible: false,
    should_queue_reply: false,
  ...
  property_specific_non_owner: Object.freeze({
    next_stage: "property_scoped_non_owner",
    template_use_case: null,
    safety_tier: SELLER_FLOW_SAFETY_TIERS.REVIEW,
    auto_send_eligible: false,
    should_queue_reply: false,
  ...
  former_owner_respondent: Object.freeze({
    next_stage: "former_owner",
    template_use_case: null,
    safety_tier: SELLER_FLOW_SAFETY_TIERS.REVIEW,
    auto_send_eligible: false,
    should_queue_reply: false,
  ...
  tenant_respondent: Object.freeze({
    next_stage: "tenant_or_occupancy",
    template_use_case: "tenant_or_occupancy",
    safety_tier: SELLER_FLOW_SAFETY_TIERS.REVIEW,
    auto_send_eligible: false,
  ...
  property_manager_respondent: Object.freeze({
    next_stage: "property_manager",
    template_use_case: null,
    safety_tier: SELLER_FLOW_SAFETY_TIERS.REVIEW,
    auto_send_eligible: false,
    should_queue_reply: false,
  ...
  co_owner_respondent: Object.freeze({
    next_stage: "authorized_spouse",
    template_use_case: null,
    safety_tier: SELLER_FLOW_SAFETY_TIERS.REVIEW,
    auto_send_eligible: false,
    should_queue_reply: false,
  ...
  executor_heir_respondent: Object.freeze({
    next_stage: "executor_or_heir",
    template_use_case: null,
    safety_tier: SELLER_FLOW_SAFETY_TIERS.REVIEW,
    auto_send_eligible: false,
    should_queue_reply: false,
  ...
  entity_representative_respondent: Object.freeze({
    next_stage: "entity_representative",
    template_use_case: null,
    safety_tier: SELLER_FLOW_SAFETY_TIERS.REVIEW,
    auto_send_eligible: false,
    should_queue_reply: false,
  ...
  condition_disclosed: Object.freeze({
    next_stage: "condition_disclosed",

 ...
 * | Wrong number flag                 | phones.phone_contact_status            | evaluateCanonicalContactability   | 3          |
 * | Thread contactability             | inbox_thread_state.contactability_status | contactabilityBlocksSend        | 4          |
 * | Thread paused / quarantine        | inbox_thread_state.status, metadata    | evaluateCanonicalContactability   | 5          |
 * | Legacy thread suppression         | deal_thread_state.opt_out, inbox_bucket| evaluateCanonicalContactability   | 6          |
 * | Hard inbound intents              | message_events.detected_intent         | evaluateCanonicalContactability   | 7          |

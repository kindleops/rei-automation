...
export const RAW_MAP_FILTER_FIELD_DEFINITIONS = [
  ...
  field({ key: "property.master_owner_id", entity: "property", table: "properties", column: "master_owner_id", label: "Master Owner ID", description: "Linked Master Owner identifier.", category: "Identity & Geography", dataType: "text", populatedRows: P, valueSource: "free_text" }),

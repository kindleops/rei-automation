...
/**
 * Item 5D.5 §4: record-level storage classification — what KIND of record this
 * is, distinct from operational lifecycle. Hardens against garage / storage-condo
 * / accessory / miscoded false positives. A single binary `is_storage` flag is
 * NEVER sufficient for OPERATING_SELF_STORAGE_FACILITY.
 */
export const STORAGE_RECORD_CLASS = Object.freeze({
  OPERATING_SELF_STORAGE_FACILITY: 'OPERATING_SELF_STORAGE_FACILITY',
  MINI_STORAGE_FACILITY: 'MINI_STORAGE_FACILITY',
  CLIMATE_CONTROLLED_STORAGE: 'CLIMATE_CONTROLLED_STORAGE',
  RV_BOAT_VEHICLE_STORAGE: 'RV_BOAT_VEHICLE_STORAGE',
  STORAGE_CONDOMINIUM: 'STORAGE_CONDOMINIUM',
  GARAGE_OR_ACCESSORY_STORAGE: 'GARAGE_OR_ACCESSORY_STORAGE',
  WAREHOUSE_WITH_STORAGE_LABEL: 'WAREHOUSE_WITH_STORAGE_LABEL',
  PORTABLE_STORAGE_BUSINESS: 'PORTABLE_STORAGE_BUSINESS',
  DEVELOPMENT_SITE: 'DEVELOPMENT_SITE',
  LAND_ONLY_STORAGE_USE: 'LAND_ONLY_STORAGE_USE',
  AMBIGUOUS_STORAGE: 'AMBIGUOUS_STORAGE',
  NOT_SELF_STORAGE: 'NOT_SELF_STORAGE',
});

/** Record classes that may be priced/underwritten as a genuine operating facility. */
export const PRICING_ELIGIBLE_RECORD_CLASSES = Object.freeze([
  STORAGE_RECORD_CLASS.OPERATING_SELF_STORAGE_FACILITY,
  STORAGE_RECORD_CLASS.MINI_STORAGE_FACILITY,
  STORAGE_RECORD_CLASS.CLIMATE_CONTROLLED_STORAGE,
  STORAGE_RECORD_CLASS.RV_BOAT_VEHICLE_STORAGE,
]);

/** Minimum classifier confidence to treat a record as an operating facility. */
export const OPERATING_FACILITY_MIN_CONFIDENCE = 60;

/** Item 5D.5 §6: storage model production-readiness states (ordered, coarse). */
export const STORAGE_READINESS = Object.freeze({

-- Update v_sms_ready_contacts seller_full_name derivation.
--
-- Remove fallback to phones.phone_owner because it can contain carrier labels
-- (AT&T Mobility, T-Mobile, Verizon Wireless) and is not a contact name.

...
export function normalizeDealContext(row: AnyRecord): DealContext {
  ...
  if (row.identity && row.property && row.prospect) {
    ...
    return {
      ...
      latitude: firstNumber(prop.latitude, prop.lat, row.latitude, row.lat, 0),
      longitude: firstNumber(prop.longitude, prop.lng, row.longitude, row.lng, 0),
      ...
      lat: firstNumber(prop.latitude, prop.lat, row.latitude, row.lat, 0),
      lng: firstNumber(prop.longitude, prop.lng, row.longitude, row.lng, 0),
  ...
  return {
    ...
    // Property fields
    latitude: firstNumber(row.latitude, row.lat, property.latitude, property.lat, propertyRaw.latitude, propertyRaw.lat, 0),
    longitude: firstNumber(row.longitude, row.lng, property.longitude, property.lng, propertyRaw.longitude, propertyRaw.lng, 0),
    ...
    lat: firstNumber(row.latitude, row.lat, property.latitude, property.lat, propertyRaw.latitude, propertyRaw.lat, 0),
    lng: firstNumber(row.longitude, row.lng, property.longitude, property.lng, propertyRaw.longitude, propertyRaw.lng, 0),

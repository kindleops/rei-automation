...
export function buildCalendarProofFixtures(anchor = new Date()): CalendarEvent[] {
  ...
  return [
    ...
    },
    {
      ...
      title: 'Offer expiration', timestamp: at(16),
    ...
    },
    {
      ...
      title: 'Contract signature', timestamp: at(17),
      sourceTable: 'contracts', status: 'awaiting_signature', overdue: false, reschedulable: false,
    },
    {
      ...base, id: 'proof:title', type: 'title_milestone', tone: 'gold',
      title: 'Title milestone', timestamp: at(13),
      sourceTable: 'title_routing_closing_engine', status: 'scheduled', overdue: false, reschedulable: false,
    },
    {
      ...base, id: 'proof:closing', type: 'closing_scheduled', tone: 'emerald',
      title: 'Closing scheduled', timestamp: at(15), allDay: true,
      sourceTable: 'closings', status: 'scheduled', overdue: false, reschedulable: false,
    },
    {
      ...base, id: 'proof:manual-task', type: 'manual_task', tone: 'gray',
      title: 'Review comps', timestamp: at(8), sourceTable: 'calendar_manual_events',
      sourceDomain: 'manual', status: 'scheduled', overdue: false, reschedulable: true, editable: true,
      sourceRecordId: 'manual-proof-1',
    },
    {
      ...base, id: 'proof:reminder', type: 'manual_reminder', tone: 'gray',
      title: 'Call title company', timestamp: at(12), sourceTable: 'calendar_manual_events',
      sourceDomain: 'manual', status: 'scheduled', overdue: false, reschedulable: true, editable: true,
      sourceRecordId: 'manual-proof-2',
    },
    {
      ...base, id: 'proof:overdue', type: 'scheduled_sms', tone: 'red',
      title: 'Overdue queue send', timestamp: new Date(anchor.getTime() - 86400000 * 2).toISOString(),
      sourceTable: 'send_queue', sourceDomain: 'queue', status: 'scheduled',

...
export const DealIntelligence25Panel = ({
  ...
  const leadStateData: DealIntelligenceLeadStateData | null = threadKey ? {
    ...
    is_read: convoState?.is_read as boolean | null | undefined,
    automation_state: (convoState?.automation_state ?? convoState?.autopilot_mode) as string | null | undefined,
    automation_status: (convoState?.automation_status ?? convoState?.queue_status) as string | null | undefined,
